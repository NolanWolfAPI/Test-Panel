...
export const ISO6391_DROPDOWN_CONTROL_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => ISO6391DropDownComponent),
  multi: true
};

@Component ({
  selector: "iso6391-dropdown",
  templateUrl: "../dropdown/dropdown.component.html",
  styleUrls: ["../dropdown/dropdown.component.scss"],
  providers: [ISO6391_DROPDOWN_CONTROL_VALUE_ACCESSOR]
})
export class ISO6391DropDownComponent extends DropDownComponent implements OnInit{
